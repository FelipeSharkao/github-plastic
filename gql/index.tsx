...
export type RepositoriesQuery = { user?: Maybe<(
    Pick<User, 'id'>
    & { repositories: { edges?: Maybe<Array<Maybe<(
        Pick<RepositoryEdge, 'cursor'>
        & { node?: Maybe<(
          Pick<Repository, 'id' | 'name' | 'description' | 'forkCount' | 'stargazerCount'>
          & { primaryLanguage?: Maybe<Pick<Language, 'id' | 'name'>> }
        )> }
      )>>> } }
  )> };
...
export type UserQuery = { user?: Maybe<(
    Pick<User, 'id' | 'name' | 'bio' | 'websiteUrl' | 'company'>
    & { followers: Pick<FollowerConnection, 'totalCount'>, following: Pick<FollowingConnection, 'totalCount'>, repositories: Pick<RepositoryConnection, 'totalCount'> }
  )> };
